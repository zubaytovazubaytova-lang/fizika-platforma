...
(async () => {
  ...
  const email = `bikecheck5_${Date.now()}@test.local`;
  ...
  // wider crop covering frame + both wheels (extend lower & include more width)
  await page.screenshot({ path: 'd13_crop.png',
    clip: { x: box.x + cw*0.24, y: box.y + ch*0.69, width: cw*0.18, height: ch*0.30 } });
