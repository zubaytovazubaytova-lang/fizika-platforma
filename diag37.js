...
(async () => {
  ...
  const email = `bikecheck37_${Date.now()}@test.local`;
  ...
  // Step A: 4 wheel-steps centered on bike's initial position (~0.196, 0.703 per d33_locate, before any zoom)
  ...
  await canvas.screenshot({ path: 'd37_step1.png' });
